  ...
  return (
    <div className="min-h-screen bg-neutral-100 flex flex-col">
      ...
      <main className="flex-1 px-6 py-5 max-w-7xl mx-auto w-full">
        ...
        {loading ? (
          <p className="text-sm text-neutral-400 animate-pulse">Loading kitchen queue…</p>
        ) : orders.length === 0 ? (
              ...
              return (
                <div
                  ...
                  className={[
                    ...
                    isPreparing ? 'border-l-emerald-500 border-y border-r border-neutral-200' : 'border-l-rose-500 border-y border-r border-neutral-200',
                  ].join(' ')}
                >
